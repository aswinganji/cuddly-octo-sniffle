...
try:
    ...
    walkers_bluprint = random.choice(get_blueprint_of_world.filter('walker'))
    walkers_spawn_point = world.get_map().get_spawn_points()[15]
    dropped_walker = world.spawn_actor(walkers_bluprint,walkers_spawn_point)
